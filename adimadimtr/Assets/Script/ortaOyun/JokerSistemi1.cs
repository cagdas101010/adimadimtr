...
public class JokerSistemi1 : MonoBehaviour
{
    public Color orjinalRenk, dogruRenk1, yanlisRenk1;
    public List<string> ihtimaller;
    public GameObject[] secenekler;
    public Button[] jokerlerim1;
    ...
    {
        for (int i = 0; i < jokerlerim1.Length; i++)
        {
            jokerlerim1[i].interactable = true;
        }
    }

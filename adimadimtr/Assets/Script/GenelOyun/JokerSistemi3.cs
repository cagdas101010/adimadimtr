...
public class JokerSistemi3 : MonoBehaviour
{
    public Color orjinalRenk, dogruRenk3, yanlisRenk3;
    public List<string> ihtimaller;
    public GameObject[] secenekler;
    public Button[] jokerlerim3;
    ...
    {
        for (int i = 0; i < jokerlerim3.Length; i++)
        {
            jokerlerim3[i].interactable = true;
        }
    }
